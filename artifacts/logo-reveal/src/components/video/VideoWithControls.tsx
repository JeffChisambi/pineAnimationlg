...
export default function VideoWithControls() {
  ...
  // Export path: no props so recording markers fire correctly
  ...
  return (
    <div className="relative w-full h-[100dvh] bg-black">
      ...
      />
      {/* Control sensor + bar — positioned to float over the portrait video */}
      <div
        ref={sensorRef}
        className="absolute bottom-0 left-0 right-0 z-50 flex flex-col justify-end max-w-[56.25vh] mx-auto"
        style={{ height: '25%' }}
